...
EOF
    ...
    bin/kafka-reassign-partitions.sh --bootstrap-server localhost:9092 --reassignment-json-file candidate-reassignment.json --execute

    # Give some time to reassignments to occur
    sleep 5

    # Verify partition reassignment status
    bin/kafka-reassign-partitions.sh --bootstrap-server localhost:9092 --reassignment-json-file candidate-reassignment.json --verify
