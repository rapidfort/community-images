...
This MongoDB® container was hardened by RapidFort’s container optimization process. This container is free to use and has no license limitations.

It is the same as [bitnami/mongodb][source-image-dh-link] image, but much more secure.
...
This image is a hardened version of the official [bitnami/mongodb][source-image-dh-link] image available here on Docker Hub.

RapidFort is an industry-leading container optimization solution that minimizes software attack surface by removing unused code. Most containers can be reduced by at least 50%, which reduces the opportunity for malicious attacks and CVE exploits. Learn more at RapidFort.com.
...
[ft-badge]: https://github.com/rapidfort/community-images/actions/workflows/mongodb_ft.yml/badge.svg
[ft-badge-link]: https://github.com/rapidfort/community-images/actions/workflows/mongodb_ft.yml
