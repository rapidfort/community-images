...
It is the same as the [Bitnami NATS][source-image-dh-link] image but more secure.
...
This image is a hardened version of the official [Bitnami NATS][source-image-dh-link] image on Docker Hub.
...
## What’s the difference between the official [Bitnami NATS][source-image-dh-link] image and this hardened image?
...
[rf-image-link]: ?utm_source=gh-ci-image&utm_medium=view-report&utm_id=rsa-ci-2022
...
[source-image-dh-link]: https://hub.docker.com/r/bitnami/nats
