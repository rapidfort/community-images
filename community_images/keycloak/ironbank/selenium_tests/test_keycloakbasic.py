...
class TestYourlsuitest():
    ...
    def test_yourlsuitest(self, params):
        ...
        self.driver.get("http://localhost:{}/admin/master/console/#/master/users/add-user".format(params["port"]))

        self.driver.find_element(By.ID, "requiredActions").click()
        ...
        self.driver.find_element(By.XPATH, "//span[contains(text(),\'Keycloak\')]").click()
        self.driver.find_element(By.XPATH, "//a[contains(text(),\'Create realm\')]").click()
        self.driver.find_element(By.ID, "realm").click()
        self.driver.find_element(By.ID, "realm").send_keys("test-realm")
        self.driver.find_element(By.CSS_SELECTOR, ".pf-m-primary").click()
