...
It is the same as the [bitnami/postgresql][source-image-dh-link] image but more secure.
...
This image is a hardened version of the official [bitnami/postgresql][source-image-dh-link] image on Docker Hub.
...
[dh-img-size-badge]: https://img.shields.io/docker/image-size/rapidfort/postgresql?logo=docker&logoColor=orange&sort=semver
[dh-img-pulls-badge]: https://img.shields.io/docker/pulls/rapidfort/postgresql?logo=docker&logoColor=orange
