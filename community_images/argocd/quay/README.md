...
RapidFort’s container optimization process hardened this Argo CD Quay container. This container is free to use and has no license limitations.

It is the same as the [Quay Argo CD Quay][source-image-repo-link] image but more secure.
