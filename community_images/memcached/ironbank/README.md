...
RapidFort’s container optimization process hardened this Memcached IronBank container. This container is free to use and has no license limitations.

It is the same as the [Platform One Memcached IronBank][source-image-repo-link] image but more secure.
