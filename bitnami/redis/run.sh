...
test_tls()
{
    ...
    # Install redis
    helm install ${HELM_RELEASE}  ${IREPO} --namespace ${NAMESPACE} --set image.tag=${TAG} --set tls.enabled=true --set tls.autoGenerated=true --set tls.authClients=false -f overrides.yml
