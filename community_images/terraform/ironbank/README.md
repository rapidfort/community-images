...
RapidFort’s container optimization process hardened this Terraform IronBank container. This container is free to use and has no license limitations.

It is the same as the [Platform One Terraform IronBank][source-image-repo-link] image but more secure.
...
```sh
$ docker run -i -t  rapidfort/terraform-ib:latest
...
RapidFort’s hardened [rapidfort/terraform-ib][rf-dh-image-link] image has been optimized by our proprietary scanning and slimming technology. We are big fans of open-source software, containerized infrastructure, and security.
