...
This PostgreSQL container was hardened by RapidFort’s container optimization process. This container is free to use and has no license limitations.

It is the same as [bitnami/postgresql][source-image-dh-link] image, but much more secure.
...
This image is a hardened version of the official [bitnami/postgresql][source-image-dh-link] image available here on Docker Hub.
