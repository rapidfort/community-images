...
RapidFort’s container optimization process hardened this MySQL Official container. This container is free to use and has no license limitations.

It is the same as the [The Docker Community MySQL Official][source-image-repo-link] image but more secure.
