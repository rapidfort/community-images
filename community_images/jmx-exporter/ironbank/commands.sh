...
java -javaagent:./jmx_prometheus_javaagent-0.20.0.jar=12345:/opt/jmx_exporter/jmx-configs/java-agent-config.yaml -jar /opt/jmx_exporter/hello-world.jar || echo 0 &
